  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-slate-900/95 backdrop-blur-md border-b border-blue-500/30 transition-all shadow-lg">
      <div className="flex items-center gap-4 flex-1">
        {/* Mobile menu button */}
        <button 
          className="lg:hidden p-2 hover:bg-blue-500/10 rounded-lg transition-all text-blue-400 hover:shadow-lg"
      ...
      <div className="flex items-center gap-4">
        {/* User Info */}
        <div className="flex items-center gap-2 px-3 py-2 text-xs bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/30 rounded-lg shadow-lg backdrop-blur-sm">
        ...
        {/* Current Date/Time */}
        <div className="hidden md:block text-sm text-gray-400 font-medium bg-slate-800 px-3 py-1.5 rounded-lg border border-blue-500/30">
